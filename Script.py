class script(object):  
    START_TXT = """<blockquote>Hey 👋 {user}, ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{bot}>{bot}</a></blockquote>
...
Contact me here i will make for you @champaklalbot
<b>ᴅᴇᴠ: <a herf=https://t.me/devbots2>Devbots</a></b>"""
...
╭─── • ❰ @DEVBOTS2 ❱ • ────➤
┣ ▫️ <a href='https://t.me/iPopkornBot_ipop_bot'>Update Channel</a>
┣ ▫️ <a href='https://t.me/champaklalbot'>Support</a>
╰─────── • ◆ • ───────➤

‼️ Important ‼️
This file will be deleted in 5 minutes to prevent copyright issue. forword it anywhere else to save it

ये फाइल 5 मिनिट में डिलीट हो जायेगी । फाइल को कही और फॉरवर्ड करे ।"""
...
<b>Cᴏᴍᴍᴀɴᴅ & Uꜱᴀɢᴇ {Only for ADMIN}</b>
